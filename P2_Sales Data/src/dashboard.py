...
def run_dashboard(data_path="sales_data.csv"):
    ...
    fig.text(
        0.02, 0.31, "CATEGORY", fontweight="bold", color="gray", fontsize=9
    )
    ...
    def update(val=None):
        ...
        fig._kpi_text_obj = fig.text(
            ...
            color="darkslategrey",
            bbox=dict(
                boxstyle="round,pad=0.5", facecolor="white", edgecolor="tan"
            ),
        )
        ...
        ax_subcat.barh(
            sub_s.index, sub_s.values, color="darkgoldenrod", height=0.6
        )
        ax_subcat.set_title(
            "Top Sub-Categories",
            fontsize=10,
